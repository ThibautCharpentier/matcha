...
export default function InputSelectPicture({onAddCroppedImage, onRemoveImage, index, btnAddImage, isProfilPicture, setError}) {
        ...
        reader.addEventListener("load", () => {
            ...
            imageElement.addEventListener("load", (e) => {
                ...
                if (!naturalWidth || !naturalHeight) {
                    setError("Failed to retrieve image dimensions.");
                    return setImgSrc("");
                }
    ...
    return (
        <>
            ...
            {btnAddImage ? (
                ...
                >
                    <div className="absolute -bottom-2 -right-2 bg-gray-300 w-7 h-7 rounded-full flex justify-center items-center hover:w-8 hover:h-8">
