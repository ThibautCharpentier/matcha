...
export default function BtnDislikeBlockReport({roomSelected, setRoomSelected}) {
    ...
    const handleBlockBtn = () => {
        Request.blockMatch(roomSelected.contact_id);
    }

    const handleReportBtn = () => {
        Request.reportMatch(roomSelected.contact_id);
    }

    return (
        <div className='relative w-full'>  
            <button className='cursor-pointer' onClick={() => setActivateDots(prev => !prev)}>
                <svg width="24px" height="24px" viewBox="0 0 24 24" id="three-dots" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="_20x20_three-dots--grey" data-name="20x20/three-dots--grey" transform="translate(24) rotate(90)"> <rect id="Rectangle" width="24" height="24" fill="none"></rect> <circle id="Oval" cx="1" cy="1" r="1" transform="translate(5 11)" stroke="#000000" strokeMiterlimit="10" strokeWidth="0.5"></circle> <circle id="Oval-2" data-name="Oval" cx="1" cy="1" r="1" transform="translate(11 11)" stroke="#000000" strokeMiterlimit="10" strokeWidth="0.5"></circle> <circle id="Oval-3" data-name="Oval" cx="1" cy="1" r="1" transform="translate(17 11)" stroke="#000000" strokeMiterlimit="10" strokeWidth="0.5"></circle> </g> </g></svg>
            </button>
            {activateDots && (
                <div className='absolute z-10  bg-white border border-gray-300 rounded-md shadow-md overflow-y-auto right-0 w-48 flex flex-col items-start'>
                    <button className='flex flex-row items-center hover:bg-gray-100 w-full cursor-pointer p-2' onClick={handleDislikeBtn}>
                        ...
                        <p className='ml-1'>Retirer le match</p>
                    </button>
                    <button className='flex flex-row items-center hover:bg-gray-100 w-full cursor-pointer p-2' onClick={handleBlockBtn}>
                    ...
                    <button className='flex flex-row items-center hover:bg-gray-100 w-full cursor-pointer p-2' onClick={handleReportBtn}>
