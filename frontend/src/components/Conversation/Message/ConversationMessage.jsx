...
export default function ConversationMessage({roomIdSelected}) {
			...
			{windowSize > 640 && <div className="border-gray-300 border-l-[1px] flex flex-col justify-center h-screen sm:w-7/12 lg:w-3/4 text-center">
				{roomIdSelected === -1 ? (
					...
					<div className='h-screen flex flex-col justify-end'>	
						<div className='flex-1 overflow-y-auto bg-pink-200 p-4'>
							<AllMessages 
