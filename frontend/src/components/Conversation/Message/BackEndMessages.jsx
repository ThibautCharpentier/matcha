...
export default function BackEndMessages({ messagesContainerRef, autoScroll, notifNewMessage, setNotifNewMessage }) {
    ...
    return (
        <div 
            className={`absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-[--color-light-green] shadow-lg transition-all duration-300 cursor-pointer hover:bg-[--color-dark-green]
        ...
        >
            ...
            {!notifNewMessage ? (
                ...
                <div className='flex flex-row justify-center items-center '>
                    ...
                    <p className='text-sm'>{notifNewMessage.content}</p>
                </div>
            )}
        </div>
    );
