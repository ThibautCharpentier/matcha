...
export default function BtnUnlikeBlockReport({idContact, functionDeleteContact}) {
            ...
            <div className='relative w-full'>  
                ...
                {activateDots && (
                    <div className='absolute z-10  bg-white border border-gray-300 rounded-md shadow-md overflow-y-auto right-0 w-48 flex flex-col items-start'>
                        <button className='flex flex-row items-center hover:bg-gray-100 w-full cursor-pointer p-2' onClick={() => setIsModalUnlikeOpen(true)}>
