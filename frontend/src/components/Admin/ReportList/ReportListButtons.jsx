	...
	return (
		<div className="bg-gray-200 w-full rounded-3xl max-h-[60px] aspect-[20/3] sm:h-[60px] justify-center flex items-center">
            <div className="text-gray-500 flex flex-row items-center justify-between">
				<button onClick={confirmReport} className="btn-match flex justify-center items-center w-11 h-11 sm:w-12 sm:h-12 p-2 mr-2 sm:mr-3">
				...
				<button onClick={deleteReport} className="btn-match flex justify-center items-center w-11 h-11 sm:w-12 sm:h-12 p-2 ml-2 sm:ml-3">
