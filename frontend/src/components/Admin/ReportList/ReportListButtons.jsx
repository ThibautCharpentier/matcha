	...
	return (
		<div className="bg-gray-200 w-full rounded-3xl max-h-[60px] aspect-[20/3] sm:h-[60px] justify-center flex items-center">
            <div className="text-gray-500 flex flex-row items-center justify-between">
				<button onClick={confirmReport} className="btn-match shadow-md flex justify-center items-center w-11 h-11 sm:w-12 sm:h-12 p-2 mr-2 sm:mr-3 transition-transform duration-200 hover:scale-125">
				<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M18.364 18.364C19.9926 16.7353 21 14.4853 21 12C21 7.02944 16.9706 3 12 3C9.51472 3 7.26472 4.00736 5.63604 5.63604M18.364 18.364C16.7353 19.9926 14.4853 21 12 21C7.02944 21 3 16.9706 3 12C3 9.51472 4.00736 7.26472 5.63604 5.63604M18.364 18.364L5.63604 5.63604" stroke="#e5383b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>
				</button>
                ...
                <button onClick={switchToggleProfile}
                    className="relative w-16 h-6 sm:w-24 sm:h-8 bg-gray-500 rounded-full"
                >
                <div
				...
				<button onClick={deleteReport} className="btn-match shadow-md flex justify-center items-center w-11 h-11 sm:w-12 sm:h-12 p-2 ml-2 sm:ml-3 transition-transform duration-200 hover:scale-125">
