				...
				<div className="flex flex-row space-x-6 p-4">
					...
					<div className="flex flex-col items-start justify-center text-white text-sm w-0 flex-grow">
						...
						<div className="flex space-x-1 flex-row mt-3">
							<svg className="translate-y-[3px]" height="15px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ec80a8" strokeWidth="0.00016"><path d="M1.24264 8.24264L8 15L14.7574 8.24264C15.553 7.44699 16 6.36786 16 5.24264V5.05234C16 2.8143 14.1857 1 11.9477 1C10.7166 1 9.55233 1.55959 8.78331 2.52086L8 3.5L7.21669 2.52086C6.44767 1.55959 5.28338 1 4.05234 1C1.8143 1 0 2.8143 0 5.05234V5.24264C0 6.36786 0.44699 7.44699 1.24264 8.24264Z" fill="#ec80a8"></path></svg>
							<p>{Math.round((myData.famerating * 100) * 100) / 100} %</p>
						</div>
						<div className="text-xs mt-3">
							<div className="flex space-x-1 flex-row">
								<svg className="translate-y-[3px]" height="10px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="8" fill="#b5d8ad" /></svg>
								<p>en ligne</p>
							</div>
						</div>
					</div>
				...
				<div style={{ overflowY: 'auto' }} className="h-full p-1">
					...
					>
						{(!myData.interest || myData.interest.length < 1) && (
							<>
								<svg height="15px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#4b5563"><path d="M4 12H20M12 4V20" stroke="#4b5563" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
					...
					<div>
						<div className="mt-5 flex flex-row justify-between">
							...
							{inputText && inputText.trim() !== '' && inputText.trim() !== myData.bio && (
								<button className="bg-gray-200 border-2 border-gray-200 rounded-md hover:bg-gray-300 hover:border-gray-300" onClick={handleSaveBio}>
									<svg height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M17.0303 8.78039L8.99993 16.8107L5.4696 13.2804L6.53026 12.2197L8.99993 14.6894L15.9696 7.71973L17.0303 8.78039Z" fill="#000000" /></svg>
								</button>
							)}
						</div>
