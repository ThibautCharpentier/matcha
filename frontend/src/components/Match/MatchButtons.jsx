	...
	return (
		<div className="bg-gray-200 w-full rounded-3xl max-h-[60px] aspect-[20/3] sm:h-[60px] justify-center flex items-center">
            <div className="text-gray-500 flex flex-row items-center justify-between">
				<button onClick={ignoreMatch} className="btn-match shadow-md flex justify-center items-center w-11 h-11 sm:w-12 sm:h-12 p-2 mr-2 sm:mr-3 transition-transform duration-200 hover:scale-125">
                ...
                <button onClick={() => {
                    ...
                    className="relative w-16 h-6 sm:w-24 sm:h-8 bg-[--color-dark-green] rounded-full"
                >
                <div
