export default function MatchButtons({toggleProfile, switchToggleProfile}) {
	return (
		<div className="absolute flex space-x-7 bottom-1 left-1/2 -translate-x-1/2">
			<button className="btn-match flex justify-center items-center w-14 h-14 sm:w-16 sm:h-16 p-2">
			...
			{(toggleProfile ?
				<button onClick={switchToggleProfile} className="btn flex justify-center items-center w-20 h-11 sm:w-24 sm:h-12 p-2">
					Photos
				</button>
				:
				<button onClick={switchToggleProfile} className="btn flex justify-center items-center w-20 h-11 sm:w-24 sm:h-12 p-2">
