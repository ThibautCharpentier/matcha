	...
	return (
		<>
			<div className="flex flex-col mt-6">
				<label className="font-poppins-light" htmlFor="username">Nom d'utilisateur{" "}<span className="text-xs font-poppins-light whitespace-nowrap">(entre 3 et 10 caractères)</span></label>
