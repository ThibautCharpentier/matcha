	...
	try
	{
		...
		await client.query(`
			CREATE TABLE IF NOT EXISTS public.chat (
				...
				FOREIGN KEY (user1) REFERENCES public.users(id),
				FOREIGN KEY (user2) REFERENCES public.users(id)
			)
		`);
		...
		await client.query(`
			CREATE TABLE IF NOT EXISTS public.message (
				...
				FOREIGN KEY (receiver) REFERENCES public.users(id)
			)
		`);
		...
		await client.query(`
			CREATE TABLE IF NOT EXISTS public.interaction (
				...
				FOREIGN KEY (user_id) REFERENCES public.users(id),
				FOREIGN KEY (target) REFERENCES public.users(id),
		...
		await client.query(`
			CREATE TABLE IF NOT EXISTS public.notification (
				...
				created TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
				FOREIGN KEY (user_id) REFERENCES public.users(id),
				FOREIGN KEY (from_id) REFERENCES public.users(id),
